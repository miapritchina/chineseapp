...
| BUG-14 | Medium | Review TTS distorted, "like an old radio" | v105 — `speech.ts` took the first zh voice (iOS lists the low-bitrate compact Siri voice first), rate 0.85 resampled on top, and Safari could GC the utterance mid-playback. Now: quality-scored voice pick (`pickVoice`, Enhanced/Premium > zh-CN > on-device), native rate, utterance held until end. Follow-up to BUG-11. |
